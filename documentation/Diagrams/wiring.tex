{
	...
	\begin{tikzpicture}[circuit ee IEC, every info/.style={font=\footnotesize}]
		...
		\node[ac source, label={[shift={(0, 0)}, font=\scriptsize]$230$ V}] at (-5,10) (mains) {};
		...
		\draw[gray, -Stealth] ($(mainsRight) + (0.3, 0.0)$) node[label={[shift={(0.4, -0.2)}, align=center, font=\tiny] Load\\Conductor}] {} to [bend right=10] ($(mainsRight) + (0.05,-0.3)$) {};
		
		\draw[gray, -Stealth] ($(CT) + (-1, 0)$) node[label={[shift={(-0.3, -0.6)}, align=center, font=\tiny] Current\\Transformer}] {} to [bend right=-15] ($(CT) + (-0.3, 0.05)$) {};
		...
		\draw[gray, -Stealth] ($(tmp|-current bounding box.south west) + (-0.5, 1)$) node[anchor=east,align=center, font=\tiny, text width=3cm] {Optocoupler isolation between high-voltage (mains) and low-voltage (microelectronics) circuits.} to [bend right=-5] ($(tmp|-current bounding box.south west) + (-0.05, 1)$) {};
